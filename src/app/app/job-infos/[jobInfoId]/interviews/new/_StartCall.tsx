...
export const StartCall = ({
  ...
  return (
    <div className="overflow-hidden y-auto h-screen-header flex flex-col-reverse">
...
const Messages = ({ user }: { user: { name: string; imageUrl: string } }) => {
...
const FftVisualizer = ({ fft }: { fft: number[] }) => {
  return (
